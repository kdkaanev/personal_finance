...
import CustomSelect from '../sub-component/CustomSelect.vue'
...
<template>
  ...
  <p class="text-sm">Create a pot to set savings targets. These can help keep you on track as you save for special purchases.</p>
  <form @submit.prevent="submitBudget" class="space">
    <div class="category">
      <label for="name"  >Pot Name</label>
      <input type="text" id="name" v-model="potName" class="input" placeholder="e.g. Rainy Days" required>
    </div>
    <div class="maximum">
      <label for="maximum" >Target</label>
    ...
    <button type="submit" class="btn-primary">Add Pot</button>
