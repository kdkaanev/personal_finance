...
<template>
  ...
  <p class="text-sm">Are you sure you want to delete this pot? This action cannot be reversed, and all the data inside it will be removed forever.</p>
    <div class="space">
        <button class="btn-primary red" @click="$emit('delete')">Yes, Confirm Deletion</button>
